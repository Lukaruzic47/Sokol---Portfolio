    ...
    function fetchData(orderBy, upDown){
        ...
        if (this.readyState == 4  &&  this.status == 200){
            ...
            for (let i = 0; i < AuthKolekcija.length; i++) {
                ...
                podaci += "<tr><td><img src='" + Auth_icon + "' /></td><td><p class='td-text'>" + Auth_name + "</p></td><td><p class='td-text'>" + Auth_effect + "</p></td><td><p class='td-text'>" + Auth_desc + "</p></td><td><p class='td-text'>" + Auth_election + "</p></td></tr>";
            }
