    ...
    function fetchData(orderBy, upDown){
        ...
        if (this.readyState == 4  &&  this.status == 200){
            ...
            for (let i = 0; i < TechKolekcija.length; i++) {
                ...
                podaci += "<tr><td><img src='" + Tech_icon + "'/></td><td><p class='td-text'>" + Tech_name + "</p></td><td><img src='" + Tech_category_icon + "'/><br><p class='td-text'>" + Tech_category_name + "</p></td><td><p class='td-text'>" + Tech_desc + "</p></td><td><p class='td-text'>" + Tech_effect + "</p></td><td><p class='td-text'>" + Tech_cost + "</p></td><td><p class='td-text'>" + Tech_rarity + "</p></td><td><img src='" + Tech_dlc_icon + "' /><br><p class='td-text'>" + Tech_dlc + "</p></td><td><a class='btn ad-tool-btn btn-action' href='EditTech.php?id=" + Tech_id + "' role='button'>Edit</a><a class='btn ad-tool-btn btn-action' href='DeleteTech.php?id=" + Tech_id + "'  role='button'>Delete</a></td></tr>";
            }
