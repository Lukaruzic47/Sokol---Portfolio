      ...
      function fetchData(orderBy, upDown){
        ...
        if (this.readyState == 4  &&  this.status == 200){
            ...
            for (let i = 0; i < OriginKolekcija.length; i++) {
                ...
                podaci += "<tr><td><img src='" + Origin_icon + "' /></td><td><p class='td-text'>" + Origin_name + "</p></td><td><p class='td-text'>" + Origin_effect + "</p></td><td><p class='td-text'>" + OriginRequ + "</p></td><td><img src='" + OriginDlcImg +"' /><br><p class='td-text'>" + OriginDlc + "</p></td></tr>";
            }
