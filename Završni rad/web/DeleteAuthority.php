    ...
    <div id="page-container">
        ...
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Delete Authoity</li>
            </ol>
            <div class="row">
                <!-- Article main content -->
                <article class="col-xs-12 maincontent">
                    <header class="page-header">
                        <h1 class="page-title">Delete Authority</h1>
                    </header>
                    <section id="sadrzaj">
                        <?php
                            ...
                            $upitPodaci = "select authority_icon from authority where authority_id = $Auth_id";
                            $rezultat = $baza->dohvatiDB($upitPodaci);
                            while($red = $rezultat->fetch_array()){
                                $url_dokumenta = "assets/images/Stellaris_slike/Authority/" . $red['authority_icon'];
                            }
                            

                            /* definicija SQL upita za brisanje retka iz tablice u bazi koji sadrži podatke odabrane fotografije */
                            $upitBrisi = "delete from authority where authority_id = $Auth_id";
