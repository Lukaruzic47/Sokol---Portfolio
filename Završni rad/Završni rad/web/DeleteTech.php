            ...
            <div class="row">
                ...
                <article class="col-xs-12 maincontent">
                    <header class="page-header">
                        <h1 class="page-title">Delete Technology</h1>
                    </header>
                ...
                <?php
                    ...
                    $upitPodaci = "select tech_icon from technology where tech_id = $Tech_id";
                    $rezultat = $baza->dohvatiDB($upitPodaci);
                    while($red = $rezultat->fetch_array()){
                        $ikona = "assets/images/Stellaris_slike/Technology/" . $red['tech_icon'];
                    }
                    

                    /* definicija SQL upita za brisanje retka iz tablice u bazi koji sadrži podatke odabrane fotografije */
                    $upitBrisi = "delete from technology where tech_id = $Tech_id";
