    ...
    <div id="page-container">
        ...
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Delete Ethic</li>
            </ol>
            <div class="row">
                <!-- Article main content -->
                <article class="col-xs-12 maincontent">
                    <header class="page-header">
                        <h1 class="page-title">Delete Ethic</h1>
                    </header>
                ...
                <?php
                    ...
                    $upitPodaci = "select ethic_icon from ethics where ethic_id = $Ethic_id";
                    $rezultat = $baza->dohvatiDB($upitPodaci);
                    while($red = $rezultat->fetch_array()){
                        $ikona = "assets/images/Stellaris_slike/Ethics/" . $red['ethic_icon'];
                    }
                    

                    /* definicija SQL upita za brisanje retka iz tablice u bazi koji sadrži podatke odabrane fotografije */
                    $upitBrisi = "delete from ethics where ethic_id = $Ethic_id";
