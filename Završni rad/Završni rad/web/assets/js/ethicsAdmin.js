      ...
      function fetchEthicData(orderBy, upDown){
        ...
        if (this.readyState == 4  &&  this.status == 200){
            ...
            for (let i = 0; i < EthicKolekcija.length; i++) {
                ...
                podaci += "<tr><td><img src='" + Ethic_icon + "' /></td><td><p class='td-text'>" + Ethic_name + "</p></td><td><p class='td-text'>" + Ethic_effect + "</p></td><td><p class='td-text'>" + Ethic_desc + "</p></td><td><p class='td-text'>" + Ethic_opposite + "</p></td><td><a class='btn ad-tool-btn btn-action' href='EditEthic.php?id=" + Ethic_id + "' role='button'>Edit</a><a class='btn ad-tool-btn btn-action' href='DeleteEthic.php?id=" + Ethic_id + "'  role='button'>Delete</a></td></tr>";
            }
